;(function(window, document, $, undefined){
    ...
    FixIco.include({
        ...
        initStyles: function(){
            var me = this, styles = {};
            styles[ me.ids.out ] = { position:"relative", width:"100%", height:"100%", margin:0, padding:0, border:0, 
                                    outline:"2px solid red", overflow:"hidden", zIndex: me.conf.zIndex++ };
            ...
            styles[ me.conf.dom ] = { width:me.conf.width, height:me.conf.height, padding:"10px" };
        ...
        addSimpleTiny: function(mycss){
            var me = this,
                ...
                $tiny,
                tinyId = _f.generateGUID(),
                tinycss = { position:'absolute', left:bigCenterX, top:bigCenterY, outline:'1px dashed #f00', display:'block',
                            padding:0, margin:0, width: me.conf.defTinyWidth, height: me.conf.defTinyHeight, zIndex: me.conf.zIndex++ },
